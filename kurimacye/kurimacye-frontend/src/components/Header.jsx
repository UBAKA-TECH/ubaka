      ...
      <div className="mx-auto max-w-[98%] px-2 md:px-4 h-16 flex items-center justify-between gap-1 md:gap-2 lg:gap-3 xl:gap-4">
        ...
        <div className="flex items-center gap-1 md:gap-3">
          ...
          {!isSellerOrAdminView && (
            <>
              {/* Wishlist */}
              <Link to="/wishlist" className="p-1.5 sm:p-2.5 text-charcoal-300 hover:text-white transition-colors relative group" aria-label="Wishlist">
              ...
              {/* Cart */}
              <Link to="/cart" className="relative p-1.5 sm:p-2.5 text-charcoal-300 hover:text-white transition-colors group" aria-label="Shopping Cart">
