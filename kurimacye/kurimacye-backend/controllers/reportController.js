    ...
    try {
        ...
        const doc = createKuriMacyePDF({
            ...
            contentBuilder: (pdfDoc, helpers) => {
                ...
                if (type === "inventory") {
                    ...
                    helpers.table({
                        columns: [
                            ...
                            { header: "Item Name", key: "productName", width: 165 },
                            { header: "Qty", key: "quantity", width: 30, align: "center" },
                            { header: "P/U", key: "price", width: 60, align: "right" },
                            { header: "Cash (RWF)", key: "cashTotal", width: 95, align: "right" },
                            { header: "Momo (RWF)", key: "momoTotal", width: 95, align: "right" }
                        ],
                ...
                pdfDoc.moveDown(1);
                pdfDoc.fillColor("#1E293B").fontSize(10).font("Helvetica-Bold").text(`Prepared by: ${user.name}`, { align: "right" });
            },
            logoPath: logoBuffer
        });
